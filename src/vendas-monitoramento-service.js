...
export async function listarMonitoramentoVendasSankhya(request, env) {
  ...
  "      WHEN UPPER(PRO.DESCRPROD) LIKE '%CROISSANT%' AND UPPER(PRO.DESCRPROD) LIKE '%CAIXA C/ 25 UNIDADES%' THEN 'Pão Croissant 250g'",
  "      WHEN UPPER(PRO.DESCRPROD) LIKE '%CROISSANT%' AND UPPER(PRO.DESCRPROD) LIKE '%CAIXA C/ 10 UNIDADES%' THEN 'Pão croissant 10un'",
